...
# Background
background = pygame.transform.scale(pygame.image.load('SIP_Background.png'), (800, 560))
...
# Player
playerImg = pygame.transform.scale(pygame.image.load('UFO.jpg'), (280, 190))
...
for _i in range(num_of_enemies):
    enemyImg.append(pygame.transform.scale(pygame.image.load('Alien.png'), (220, 240)))
